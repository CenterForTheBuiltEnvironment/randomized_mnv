...
in scenario A as a case study to illustrate the limitation of the
conventional method. We then added other random interruptions/noises to
the measurement set in scenarios B and C to further emphasize the better
reliability of the novel M&V method. Those interruptions considered are
only a subset of real-world issues but are representative.
